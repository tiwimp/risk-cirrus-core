...
\date    2020
*/
%macro core_get_unique_ref(prefix = tmp
                          , type = file
                          , path =
                          , engine =
                          , args =
