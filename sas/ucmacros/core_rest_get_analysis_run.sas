...
\anchor core_rest_get_analysis_run
   ...
   \brief   Retrieve Analysis Run instance(s) registered in SAS Risk Governance Framework
   ...
   \details
   This macro sends a GET request to <b><i>\<host\>:\<port\>/riskCirrusObjects/objects/&solution./analysisRuns</i></b> and collects the results in the output tables. \n
