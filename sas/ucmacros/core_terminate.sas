...
%macro core_terminate(msg =);
   ...
   %local stack;
   %let stack=;
   %core_terminate_get_macro_stack(o_call_stack_var=stack);
...
/***************************************************************************** 
 * NAME:          core_terminate_get_macro_stack
 *                              
 * PURPOSE: Returns the call stack trace of the macro calls made at this point.
 *
 * USAGE: Only used within core_terminate -- do not use outside cirr_terminate.
 *
 ...
 *
 *****************************************************************************/
%macro core_terminate_get_macro_stack(O_CALL_STACK_VAR=);
